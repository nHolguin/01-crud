            ...
            <div class="row justify-content-center">
                <form action="productos" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nombre" value="${producto.nombreProducto}" id="nombre"  placeholder="Ingrese un producto...">
                        <small id="nombre" class="form-text text-muted">Ingrese el nombre de un producto v&aacute;lido.</small>
                    </div>
                    <div class="form-group">
                        <label for="cantidad">Cantidad:</label>
                        <input type="number" class="form-control" name="cantidad" value="${producto.cantidadProducto}" id="cantidad"  placeholder="Ingrese la cantidad...">
                        <small id="cantidad" class="form-text text-muted">Ingrese la cantidad de unidades del producto.</small>
                    </div>
                    <div class="form-group">
                        <label for="precio">Precio:</label>
                        <input type="number" class="form-control" name="precio" id="precio"  value="${producto.precioProducto}" placeholder="Ingrese el precio...">
